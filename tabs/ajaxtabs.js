...
ddajaxtabssettings.loadstatustext="<img src='tabs/loading.gif' /> Collecting Data..." 
...
function ddajaxtabs(tabinterfaceid, contentdivid){
	...
	this.defaultHTML=""
	this.defaultIframe='<iframe src="about:blank" marginwidth="0" marginheight="0" frameborder="0" vspace="0" hspace="0" class="tabcontentiframe" style="width:90%; height:auto; min-height: 100px"></iframe>'
...
ddajaxtabs.prototype={
	...
	cancelautorun:function(){
		if (typeof this.autoruntimer!="undefined")
			emc_v2Interval(this.autoruntimer)
	},
